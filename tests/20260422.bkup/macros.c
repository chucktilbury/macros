...
static int consume_multi_line_comment(void) {
...
// the "//" has already been read
static int consume_single_line_comment(void) {
...
static bool process_comment(void) {
...
static bool process_directive(void) {
...
static bool process_reference(void) {
